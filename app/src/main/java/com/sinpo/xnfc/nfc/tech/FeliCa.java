...
public class FeliCa {
	...
	public final static class Tag {
		...
		public final SystemCode[] getSystemCodeList() throws IOException {
			final Command cmd = new Command(CMD_REQUEST_SYSTEMCODE, idm,  new byte[0]);
		...
		//发心跳包
	    public final byte[] reauest() throws IOException
	    {
	      return transceive(new FeliCa.Command((byte)4, this.idm, new byte[0]));
	    }
