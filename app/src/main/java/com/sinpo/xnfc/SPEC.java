...
public final class SPEC {
	...
	public enum PROP {
		...
		SEX(R.string.spec_prop_sex),
		NATION(R.string.spec_prop_nation),
		BIRTHDAY(R.string.spec_prop_brithday),
		ADDR(R.string.spec_prop_address),
		ISSUE(R.string.spec_prop_issue),
		HEAD(R.string.spec_prop_head),
		
		UUID(R.string.spec_prop_uuid),	
		IDNUM(R.string.spec_prop_idnum),
	...
	public enum APP {
		...
		SHENZHENTONG_OLD(R.string.name_szt_f),	
		...
		YANGCHENGTONG(R.string.spec_app_yangchengtong),	
